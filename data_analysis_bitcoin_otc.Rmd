---
title: "DyNet paper - Bitcoin OTC data analysis"
author:
    name: Joshua Cape
...
Data synopsis: Bitcoin OTC trust weighted signed (temporal) network

Data access: https://snap.stanford.edu/data/soc-sign-bitcoin-otc.html

Data filename (local): bitcoinotc.csv
...
```{r message=FALSE}
  ...
  soc_sign_bitcoin <-
    read_csv("soc-sign-bitcoinotc.csv",
